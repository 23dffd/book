...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5e2061a1-d7f8-4c7d-827e-a4c499c5e053
```

> `5e2061a1-d7f8-4c7d-827e-a4c499c5e053` is the password of the certificate, you can change it to any password you want.
